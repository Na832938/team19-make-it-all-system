export default function Button({
  ...
  const typeClasses = {
    primary: `
      ...
      dark:bg-[var(--primary-colour)] dark:text-[var(--surface-colour)]
    ...
    sidebarActive: `
      ...
      hover:bg-[var(--primary-hover)] active:bg-[var(--focus-colour)]
      dark:bg-[var(--primary-colour)] dark:text-[var(--surface-colour)] dark:border-[var(--primary-hover)]
      dark:hover:bg-[var(--primary-hover)] dark:active:bg-[var(--focus-colour)]
    `
  };

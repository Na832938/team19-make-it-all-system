...
export default function Card({
  ...
  return (
    <div
      className={`
        bg-[var(--surface-colour)] text-[var(--text-primary)] border border-[var(--border-neutral)]
        rounded-lg shadow-sm p-6 box-border
        transition-all duration-200 ease-in-out hover:shadow-md
        dark:bg-[var(--surface-colour)] dark:text-[var(--text-primary)] dark:border-[var(--border-neutral)]
        ${vertical
          ? "flex flex-col gap-4"

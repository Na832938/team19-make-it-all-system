        ...
        <div className="flex justify-between items-center px-6 py-3">
          ...
          <div className="flex items-center relative">
            <Button
              ...
              width="default"
              variant="sidebar"
              className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 border border-gray-200 transition-all duration-200"
            >
            ...
            {/* Dropdown */}
            {open && (
              <div className="absolute top-full right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-xl p-4 min-w-56 z-50">
                ...
                <Button
                  ...
                  size="medium"
                  width="full"
                  className="justify-center py-2 text-sm font-semibold"
                >
                  Sign Out
                </Button>
              </div>
